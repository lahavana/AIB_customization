 ...
 #Copy to C:\optimize
 write-host 'AIB Customization: OS Optimizations for WVD with Citrix Optimizer'
 $appName = 'optimize'
 $drive = 'C:'
 ...
 Expand-Archive -LiteralPath 'C:\\Optimize\\CitrixOptimizer.zip' -DestinationPath $($Localpath+"\"+$($osOptURLexe.Split('.')[0])) -Force -Verbose
 #Set-ExecutionPolicy -ExecutionPolicy RemoteSigned -Force -Verbose
 Set-Location -Path "$LocalPath\\CitrixOptimizer"

 #Run Citrix Optimize
    .\CtxOptimizerEngine.ps1 "C:\optimize\CitrixOptimizer\Templates\Citrix_Windows_10_2009.xml" -Mode Execute
